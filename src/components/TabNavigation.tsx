...
export default function TabNavigation({ activeTab, onTabChange }: TabNavigationProps) {
  return (
    <div className="flex justify-center mb-5 sm:mb-8">
      <div className="glass-strong rounded-2xl p-1.5 sm:p-2 flex gap-1 sm:gap-2 w-full max-w-md sm:max-w-2xl">
        {tabs.map((tab) => {
          const Icon = tab.icon;
          ...
          return (
            <motion.button
              ...
              className={`relative flex-1 px-2 sm:px-8 py-2.5 sm:py-3 rounded-xl font-medium transition-colors flex items-center justify-center gap-1.5 sm:gap-2 ${
